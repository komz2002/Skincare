...
function Contact() {
  ...
  return (
   ...
   <center><h2 className="parl text-center">Contact us</h2></center>
    ...
    <div className="container-fluid">
      ...
      <div className="row">
        <div className="col-lg-6">
          <h1 className="consider mt-5">Ask Us A Question</h1>
      <h4>Fill out the form or call us at (843) 823-3533.</h4>
      <img  src="https://www.holycityorthodontics.com/wp-content/uploads/2022/10/holycity-gallery2.jpg"
      alt="" className="holy"/>

    </div>
    <div className="col-lg-6">
      <h1 className="u mt-5">Contact Us</h1>
